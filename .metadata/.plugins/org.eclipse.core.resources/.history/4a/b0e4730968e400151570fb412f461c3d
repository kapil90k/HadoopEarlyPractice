...
{
	try {
		mapDriver.withInput(new LongWritable(), new Text("2,monday,abhay,holiday"))
		        .withOutput(new Text("monda"), new IntWritable(2))
		        .runTest();
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
